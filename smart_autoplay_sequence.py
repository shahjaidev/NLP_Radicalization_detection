...
f = open("video_ids_climatechange.txt", "w") 
...
#------------------------------------------------------------------------------------------------------------------------------------
    ...
    def top_k_most_relevant(self, recos, current_video_id, k=3):
        
        titles={}
        print(recos)
        cur_video= pafy.new(current_video_id)
        cur_title= cur_video.title 
